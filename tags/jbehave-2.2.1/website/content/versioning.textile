...
Version Numbering
-------------------------------------------------------------
h1(FirstChild). Version Numbering

The JBehave project follows strict rules that govern its use of version
...
Before a new major or minor release, JBehave will make release
