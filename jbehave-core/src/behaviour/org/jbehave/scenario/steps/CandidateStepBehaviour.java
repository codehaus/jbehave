...
public class CandidateStepBehaviour {
	...
	public void shouldMatchASimpleString() throws Exception {
		CandidateStep candidateStep = new Given("I laugh", SomeSteps.class.getMethod("aMethod"), null, new DollarToCaptureRegexpBuilder());
	...
	public void shouldMatchAStringWithArguments() throws Exception {
		CandidateStep candidateStep = new When("windows on the $nth floor", SomeSteps.class.getMethod("aMethod"), null, new DollarToCaptureRegexpBuilder());
	...
	public void shouldProvideARealStepUsingTheMatchedString() throws Exception {
		...
		CandidateStep candidateStep = new Then("I live on the $nth floor", SomeSteps.class.getMethod("aMethodWith", String.class), someSteps, new DollarToCaptureRegexpBuilder());
	...
	public void shouldMatchMultilineStrings() throws Exception {
		CandidateStep candidateStep = new Then("the grid should look like $grid", SomeSteps.class.getMethod("aMethod"), null, new DollarToCaptureRegexpBuilder());
	...
	public void shouldConvertArgsToAppropriateNumbers() throws Exception {
		SomeSteps someSteps = new SomeSteps();
		CandidateStep candidateStep = new Then("I should live in no. $no", SomeSteps.class.getMethod("aMethodWith", int.class), someSteps, new DollarToCaptureRegexpBuilder());
		candidateStep.createFrom("Then I should live in no. 14").perform();
		ensureThat((Integer)someSteps.args, equalTo(14));
		
		candidateStep = new Then("I should live in no. $no", SomeSteps.class.getMethod("aMethodWith", long.class), someSteps, new DollarToCaptureRegexpBuilder());
		candidateStep.createFrom("Then I should live in no. 14").perform();
		ensureThat((Long)someSteps.args, equalTo(14L));
		
		candidateStep = new Then("I should live in no. $no", SomeSteps.class.getMethod("aMethodWith", double.class), someSteps, new DollarToCaptureRegexpBuilder());
		candidateStep.createFrom("Then I should live in no. 14").perform();
		ensureThat((Double)someSteps.args, equalTo(14.0));
		
		candidateStep = new Then("I should live in no. $no", SomeSteps.class.getMethod("aMethodWith", float.class), someSteps, new DollarToCaptureRegexpBuilder());
		candidateStep.createFrom("Then I should live in no. 14").perform();
