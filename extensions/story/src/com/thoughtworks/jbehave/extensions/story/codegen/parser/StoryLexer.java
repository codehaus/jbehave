...
public class StoryLexer extends antlr.CharScanner implements StoryLexerTokenTypes, TokenStream
 {
public StoryLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public StoryLexer(Reader in) {
	this(new CharBuffer(in));
}
public StoryLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public StoryLexer(LexerSharedInputState state) {
	super(state);
