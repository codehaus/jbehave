 ...
 * for "html" format is provided by default ("ftl/jbehave-reports-html.ftl"). To
 * override, specify the the path the new template under same key "html".
 * 
 * @author Mauro Talevi
 */
public class FreemarkerReportRenderer implements ReportRenderer {
    ...
    private static Properties defaultTemplateResources() {
        ...
        resources.setProperty("html", "ftl/jbehave-reports-html.ftl");
        return resources;
    }
