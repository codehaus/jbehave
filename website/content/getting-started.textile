...
<tt>org.jbehave.core.Ensure</tt> that help with this, for instance
<tt>Ensure.that(somethingHappened)</tt> and <tt>Ensure.that(actualValue, eq(expectedValue))</tt>.
...
This is a plain Java class that implements the <tt>org.jbehave.core.util.BehavioursLoader</tt>
